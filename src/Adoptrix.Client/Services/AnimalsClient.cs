...
public interface IAnimalsClient
{
    ...
    Task<AnimalResponse> GetAsync(int animalId, CancellationToken cancellationToken = default);
}
...
public class AnimalsClient(HttpClient httpClient) : IAnimalsClient
{
    ...
    public async Task<AnimalResponse> GetAsync(int animalId, CancellationToken cancellationToken = default)
    {
