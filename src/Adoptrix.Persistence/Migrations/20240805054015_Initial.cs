...
namespace Adoptrix.Persistence.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Animals",
                columns: new[] { "Id", "BreedId", "DateOfBirth", "Description", "IsDeleted", "Name", "Sex" },
                values: new object[,]
                {
                    ...
                    { 4, 5, new DateOnly(2017, 4, 11), "Meet Percy, a charming African Grey Parrot with a personality as colorful as his feathers.", false, "Percy", "M" }
                });
